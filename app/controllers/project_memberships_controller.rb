  ...
  def create
    ...
    respond_to do |format|
      if @project_membership.save
        flash[:notice] = 'A associação foi feita com sucesso.'
        format.html {
          redirect_to(
            project_project_membership_path(@project_membership.project, @project_membership)
          )
        }
  ...
  def update
    ...
    respond_to do |format|
      if @project_membership.update_attributes(params[:project_membership])
        flash[:notice] = 'A associação foi atualizada com sucesso.'
